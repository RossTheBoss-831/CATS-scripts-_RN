                ...
                % Mean Lunge Depth
                 ...
                 % Create data row and add to table
                    ...
                    % auto-correlation
                     ...
                     temp_FeedingRate = table(WID, Lat, Lon, Year, Month, Day, DOY, HOD, MSE, CSE, HFR, MLD, UU);
                     FeedingRate = [FeedingRate; temp_FeedingRate];
                     temp_FeedingRate = [];
                  end
        end
end

clearvars -except valid_FR FeedingRate Bubble_Nets Deploy_Meta skippedprh skippedlunge skippedstrategy